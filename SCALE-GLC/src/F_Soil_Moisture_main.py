...
#    fig, ax = plt.subplots(figsize=(18,1.5 ), dpi=90)     
#    plt.rc("font", size=10)
...
####### switch red and blue color for soil moisture
    ...
    plt.rc("font", size=10)
    figplot  = ax.imshow(theta_save, extent=[0,5/ratio,1.0/ratio,0], interpolation='bicubic', cmap=cm.jet_r) #,vmin=0,vmax=0.032 #pcolor , matshow, imshow
    ...
    #beginning of the irrigation period, growing season starts
    plt.plot(np.arange(0+110,time_steps,365),np.ones(50)*0.31,'o')
    # end of the growing season
    plt.plot(np.arange(0+279,time_steps,365),np.ones(50)*0.31,'o')
